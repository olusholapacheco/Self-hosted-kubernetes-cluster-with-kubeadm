...
# Download join command from S3 bucket
aws s3 cp s3://my-terraform-state-bucket20124/kube-join-command.sh /root/join_command.sh

# Join worker nodes to the cluster
sudo bash /root/join_command.sh

# Install Flannel on worker nodes
